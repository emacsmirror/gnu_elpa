...
The popular database Postgres has an extention that allows it to have vector database functionality, [[https://github.com/pgvector/pgvector][pgvector]].  This needs the =pg-el= library.
