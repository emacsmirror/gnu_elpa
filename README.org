...
directives. This is mainly to indent relative to the paired directives (~~[~,
~~{~​, ~~(~ and ~~<~). Example:
...
- ~cl-ts-mode-format-indent-predicate~ :: A predicate for ~treesit-node-match-p~
  ...
  start of the entire format string.
...
- [X] Better support for multiple buffers/packages. Right now there practically
