;;; r-ts-mode.el --- R major mode using tree-sitter -*- lexical-binding: t; -*-

;;; Commentary:
;; A major mode for editing R code using Emacs' built-in tree-sitter support.
;; Optionally inherits from ESS for R process interaction.
