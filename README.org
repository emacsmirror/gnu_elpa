...
Earlier versions of jujutsu may colocate a Git repository with ~jj git clone --colocate REPOSITORY-URL~.
...
Test code coverage can be checked via the [[https://emacs-eldev.github.io/eldev/][Eldev]] tool and [[https://github.com/trezona-lecomte/coverage][coverage]]: run
