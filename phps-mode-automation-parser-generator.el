...
(defun phps-mode-automation-parser-generator--ensure-yacc-grammar-is-available ()
  ...
  (let ((php-yacc-url
         "https://raw.githubusercontent.com/php/php-src/refs/heads/PHP-8.5/Zend/zend_language_parser.y")
        (php-yacc-file
    ...
    (unless (file-exists-p php-yacc-file)
      (message
       ";; Downloading PHP 8.5 YACC grammar.. since %S does not exists" php-yacc-file)
      (with-current-buffer (url-retrieve-synchronously php-yacc-url)
        (write-file php-yacc-file))
      (message
       ";; Download of PHP 8.5 YACC grammar completed"))
