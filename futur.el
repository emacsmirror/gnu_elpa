...
;; Unexplained error in *Messages*:
;; [Futur] [Flymake] Obsolete report from backend elisp-flymake-byte-compile with explanation byte-compile process failed: (futur-aborted restarting)
