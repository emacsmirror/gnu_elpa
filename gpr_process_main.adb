...
package body Gpr_Process_Main is
   ...
   is begin
      return Parser : WisiToken.Parse.LR.Parser.Parser do
         Parser.Tree.Lexer := Lexer.New_Lexer (Trace, Gpr_Process_Actions.Descriptor'Access);
         Parser.Productions := Create_Productions;
         Parser.User_Data := User_Data;
         Parser.Partial_Parse_Active := Gpr_Process_Actions.Partial_Parse_Active'Access;
         Parser.Partial_Parse_Byte_Goal := Gpr_Process_Actions.Partial_Parse_Byte_Goal'Access;
