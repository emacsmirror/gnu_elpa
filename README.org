...
** Usage
  ...
  * =qrencode-string= :: Encode a specific string (leading/trailing
    whitespace trimmed).
  ...
  But due to backwards compatibility reasons we currently default to
  P1.  By customizing =qrencode-export-format= to ='p4= the export
