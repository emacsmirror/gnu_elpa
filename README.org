...
Vc-jj uses Emacs's built-in Bug Reference mode (see [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Bug-Reference.html][(emacs) Bug
...
the [[https://emacs-eldev.github.io/eldev/][Eldev]] tool, which isolates your personal Emacs configuration from
...
Eldev executable [[https://emacs-eldev.github.io/eldev/#installation][as described in the Eldev manual]].  Then in a shell
...
Emacs; see the [[https://emacs-eldev.github.io/eldev/#different-emacs-versions][corresponding manual section]] for how to do so.

Additionally, if installed, the [[https://github.com/trezona-lecomte/coverage][coverage.el]] Emacs package can be used
...
(covered) and red (not covered).  See the [[https://emacs-eldev.github.io/eldev/#undercover-plugin][associated Eldev manual
...
- [[https://git.sr.ht/~puercopop/jujutsushi][~puercopop/jujutsushi]] :: “An Emacs UI to jujutsu”
- [[https://github.com/Xylenox/majjic][Xylenox/majjic]] :: “jjui + magit-section inspired jj ui for Emacs”
