...
This package is now available on [[https://elpa.gnu.org/][elpa]], so it’s now the preferred way of installation. Being the default repository, it should be easy to use the following code on your init.el file.
...
Finally thanks to the patience of the people of the [[https://lists.gnu.org/archive/html/emacs-devel/][emacs-devel]] mailing list, particularly to [[https://github.com/zonuexe][Kenta USAMI]] and [[mailto:philipk@posteo.net][Philip Kaludercic]]. Thank you all.
