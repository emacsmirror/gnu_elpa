...
and PRs in Emacs-lisp mode buffers.  References like =bug#123= or
=issue#123= link to issues, and =pr#123= or =pull#123= link to PRs.
Matching is case-insensitive.  To follow a button, place point on it
and press =C-c RET=, or use =M-x bug-reference-push-button=.
