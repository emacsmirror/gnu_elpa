...
(ert-deftest gnosis-image-targets-occlusion-feedback-restores-source-through-resize ()
  (gnosis-test-image--feedback-resize gnosis-test-image-targets--regions "hide-target" '(1.6 1.6))
  (gnosis-test-image--feedback-resize gnosis-test-image-targets--regions "hide-all" '(1.6 1.6 1.6)))

(ert-deftest gnosis-image-targets-occlusion-native-author-save-reopen ()
  (dolist (policy '("hide-target" "hide-all"))
    (gnosis-test-image--author-roundtrip gnosis-test-image-targets--regions policy)))

(ert-deftest gnosis-image-targets-occlusion-legacy-edit-save-and-org-export ()
  (gnosis-test-image--legacy-roundtrip gnosis-test-image-targets--regions))

(ert-deftest gnosis-image-targets-native-keymap-edit-delete-and-cancel ()
  (gnosis-test-image--delete-cancel gnosis-test-image-targets--regions))
